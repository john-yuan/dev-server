 ...
 * @param {(port: number) => void} callback The callback on server started, the parameter port is the final port used.
 * @returns {Express}
 */
 ...
 * @param {number} port
 * @param {Express} app
 * @param {(port: number) => void} callback The callback on server started
 */
